...
func newDocument(db *gorm.DB, opts ...gen.DOOption) document {
	...
	_document.Alias_ = field.NewString(tableName, "alias")
	_document.Sort = field.NewInt32(tableName, "sort")
	_document.IsPublic = field.NewInt32(tableName, "is_public")
	_document.Thumbnail = field.NewString(tableName, "thumbnail")
...
func (d *document) updateTableName(table string) *document {
	...
	d.Thumbnail = field.NewString(table, "thumbnail")
...
func (d *document) fillFieldMap() {
	...
	d.fieldMap["thumbnail"] = d.Thumbnail
}
