...
func newFriend(db *gorm.DB, opts ...gen.DOOption) friend {
	...
	_friend.Description = field.NewString(tableName, "description")
	_friend.SiteURL = field.NewString(tableName, "site_url")
	_friend.AvatarURL = field.NewString(tableName, "avatar_url")
	_friend.WebsiteType = field.NewInt32(tableName, "website_type")
	_friend.IsActive = field.NewInt32(tableName, "is_active")
...
type friend struct {
	...
	SiteURL     field.String // 站点url
	AvatarURL   field.String // 头像url
	WebsiteType field.Int32  // 网站类型
	IsActive    field.Int32  // 是否激活
...
func (f *friend) updateTableName(table string) *friend {
	...
	f.WebsiteType = field.NewInt32(table, "website_type")
	f.IsActive = field.NewInt32(table, "is_active")
...
func (f *friend) fillFieldMap() {
	...
	f.fieldMap["website_type"] = f.WebsiteType
