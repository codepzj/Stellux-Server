...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.Description = field.NewString(tableName, "description")
	_post.Alias_ = field.NewString(tableName, "alias")
	_post.CategoryID = field.NewInt64(tableName, "category_id")
	_post.IsPublish = field.NewInt32(tableName, "is_publish")
	_post.IsTop = field.NewInt32(tableName, "is_top")
...
func (p *post) updateTableName(table string) *post {
	...
	p.IsPublish = field.NewInt32(table, "is_publish")
...
func (p *post) fillFieldMap() {
	...
	p.fieldMap["is_publish"] = p.IsPublish
